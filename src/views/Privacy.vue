<template>
    <div class="privacy-content">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Weatherbank.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Weatherbank, accessible from <a href="http://www.weatherbank.com"
                                                                                      rel="external nofollow noopener"
                                                                                      target="_blank">http://www.weatherbank.com</a>
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: tien.huynhminh1@hs-augsburg.de</p>
            </li>
            <li>
                <p>By phone number: +49 176 82524173</p>
            </li>
        </ul>
    </div>
</template>
